...
export const WorkplanRow: FC<WorkplanRowProps> = ({
    workplan: { title, type, id }, projectId, onEditWorkPlan, onDeleteWorkPlan
}) => {
    return (
        <Flex direction={["column", "row"]} bg="white" borderRadius="lg"  justifyContent="space-between" py={3} px={3} my={2}>
