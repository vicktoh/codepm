            ...
            <Box mt={5}>
                ...
                <HStack py={2} px={3} {...glassEffect}>
                    <Tooltip label="table view">
                        <IconButton
                            onClick={() =>
                                setCurrentView(WorkplanViewType.table)
                            }
                            colorScheme={
                                currentView === WorkplanViewType.table
                                    ? 'brand'
                                    : ''
                            }
                    ...
                    <Tooltip label="kanban view">
                        <IconButton
                            ...
                            onClick={() =>
                                setCurrentView(WorkplanViewType.kanban)
                            }
                    ...
                    <Tooltip label="calendar view">
                        <IconButton
                            ...
                            onClick={() =>
                                setCurrentView(WorkplanViewType.calendar)
                            }
